    ...
    public partial class Joinus : UserControl
    {
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                {
                    MessageBox.Show("This email is allready registored", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    cmd.CommandText = "insert into persons values('" + Firstname + "','" + Lastname + "','" + CNIC + "','" + Phone + "','" + Email + "','" + Password + "','" + Gender + "','')";
                    cmd.ExecuteNonQuery();
                    con.Close();
